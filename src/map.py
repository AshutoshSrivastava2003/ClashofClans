...
def printMap(V):
    ...
    for starch in stealtharchers:
        ...
        map_matrix[a+1][b] = starchColor(starch) + Fore.BLACK + 'ch'
        map_matrix[a][b+1] = starchColor(starch) + Fore.BLACK + 'ar'
        if starch.invisible==1 :
            map_matrix[a+1][b+1] = starchColor(starch) + Fore.BLACK + 'er'
        else :
            map_matrix[a+1][b+1] = starchColor(starch) + Fore.BLACK + ':V'
    ...
    for heal in healers:
        a= 2*heal.position[0]
        b = 2*heal.position[1]
        map_matrix[a][b] = blColor(heal) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = blColor(heal) + Fore.BLACK + 'ER'
        map_matrix[a][b+1] = blColor(heal) + Fore.BLACK + 'AL'
        map_matrix[a+1][b+1] = blColor(heal) + Fore.BLACK + '  '
